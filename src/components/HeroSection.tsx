      ...
      <div className="container relative z-10 py-8 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center lg:py-20">
          ...
          <div className="space-y-6 lg:space-y-8 fade-in order-1 lg:order-1 pt-4 lg:pt-0">
            ...
            {/* Subheadline */}
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-md leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <Button 
                className="bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white rounded-full px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-semibold w-full sm:w-auto border border-white/20"
                asChild
              >
            ...
            <div className="flex items-center gap-3 sm:gap-4 pt-2">
              <div className="flex -space-x-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 border-2 border-black/50 flex items-center justify-center">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs sm:text-sm text-gray-300">200+ local reviews</span>
              </div>
            </div>

            {/* Tag Badges */}
            <div className="flex flex-wrap gap-2 sm:gap-3 pt-2">
              <div className="flex items-center gap-1.5 sm:gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 border border-white/10">
