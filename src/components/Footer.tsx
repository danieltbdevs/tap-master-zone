    ...
    <footer>
        ...
        <div className="container py-10 md:py-16 px-4">
          <div className="text-center space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              ...
              <Button size="xl" className="w-full sm:w-auto bg-[#25D366] hover:bg-[#1ebe5a] text-white" asChild>
      ...
      <div className="bg-[#222222] text-white">
        ...
        <div className="border-b border-white/10">
          <div className="container py-4 md:py-6 px-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="flex items-center justify-center gap-3 py-2 sm:py-0">
                <Shield className="w-5 h-5 text-emergency-red flex-shrink-0" />
                <span className="text-sm text-gray-300">Gas Safe Registered</span>
              </div>
              <div className="flex items-center justify-center gap-3 py-2 sm:py-0">
                <Star className="w-5 h-5 text-emergency-red flex-shrink-0" />
        ...
        <div className="container py-10 md:py-12 px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4 col-span-2 lg:col-span-1">
              ...
              <div className="space-y-3">
                ...
                <a href="mailto:help@peterboroughplumbers.co.uk" className="flex items-center gap-3 text-sm text-gray-400 hover:text-white transition-colors py-1">
                  ...
                  <span className="break-all sm:break-normal">help@peterboroughplumbers.co.uk</span>
                </a>
                <div className="flex items-start gap-3 text-sm text-gray-400 py-1">
                  <MapPin className="w-4 h-4 text-emergency-red flex-shrink-0 mt-0.5" />
                  <span>Peterborough, Cambridgeshire, UK</span>
                </div>
              </div>

              {/* Social Media */}
              <div className="flex items-center gap-3 pt-3">
                <a href="#" className="w-10 h-10 sm:w-8 sm:h-8 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-white/20 hover:text-white transition-all">
            ...
            <div className="space-y-4 col-span-2 lg:col-span-1">
              ...
              <nav className="grid grid-cols-2 lg:grid-cols-1 gap-2.5">
        ...
        <div className="border-t border-white/10">
          <div className="container py-5 md:py-6 px-4">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4 text-center md:text-left">
              ...
              <p className="text-xs text-gray-500">
                Fully Insured • Gas Safe Registered • No Call-Out Fee
              </p>
            </div>
          </div>
        </div>
