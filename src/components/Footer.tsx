        ...
        <div className="container py-10 md:py-12 px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4 col-span-2 lg:col-span-1">
              ...
              {/* Social Media - 44px touch targets */}
              <div className="flex items-center gap-3 pt-3">
                <a href="#" className="w-11 h-11 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-white/20 hover:text-white transition-all">
