        ...
        <div className="border-b border-white/10">
          <div className="container py-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              ...
              <div className="flex items-center justify-center gap-3">
                <Star className="w-5 h-5 text-emergency-red" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a href="tel:+441234567890" className="flex items-center gap-3 text-sm text-gray-400 hover:text-white transition-colors">
                  <Phone className="w-4 h-4 text-emergency-red flex-shrink-0" />
                  01234 567 890
                </a>
                <a href="mailto:help@peterboroughplumbers.co.uk" className="flex items-center gap-3 text-sm text-gray-400 hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-3 pt-2">
                <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-white/20 hover:text-white transition-all">
              ...
              <nav className="flex flex-col space-y-2">
                {policyLinks.map((link) => (
                  <a 
                    key={link.label}
                    href={link.href} 
                    className="text-sm text-emergency-red hover:text-red-400 transition-colors"
                  >
                    {link.label}
                  </a>
                ))}
